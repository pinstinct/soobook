...
IMAGE_BASE = 'soobook-base'
IMAGE_BASE2 = 'soobook-base2'
IMAGE_DEBUG = 'soobook-debug'
IMAGE_PRODUCTION = 'soobook-production'
IMAGE_DOCKERHUB = 'soobook'
